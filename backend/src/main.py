...
from src.api.routes import features as features_routes
...
from src.api.routes import platform_audit as platform_audit_routes
...
def create_app() -> FastAPI:
    ...
    configure_logging(settings.ENV, log_level=settings.LOG_LEVEL)
    ...
    app.include_router(platform_audit_routes.router, prefix="/api/platform", tags=["platform"])
    app.include_router(announcements_routes.router, prefix="/api/app", tags=["announcements"])
    app.include_router(features_routes.router, prefix="/api/app", tags=["features"])
    ...
    app.include_router(cockpit_routes.router, prefix="/api/calendario/consolidado", tags=["cockpit"])
